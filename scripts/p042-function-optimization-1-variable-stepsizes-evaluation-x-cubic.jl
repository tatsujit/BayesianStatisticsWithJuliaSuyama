...
program_name = "p042-function-optimization-1-variable-stepsizes-evaluation-x-cubic"
...
x_limits = (nothing, (10^(0), 10^10))
f_limits = (nothing, (10^(0), 10^30))
